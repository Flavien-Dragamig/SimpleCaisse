# Courriel de prise de contact, HelloAsso

Objet :
1. SimpleCaisse, un outil libre pour la caisse physique des événements associatifs
2. Un bordereau de comptage en aval de HelloAsso, outil libre et gratuit
...
HelloAsso y figure comme moyen de paiement à part entière, avec les espèces, la carte et le chèque. L'outil affiche aussi en QR code plein écran la page HelloAsso de l'association, pour payer en ligne depuis la table.

Vous indiquez ne pas faire la comptabilité des associations et conseillez de conserver des bordereaux de comptage à part. SimpleCaisse couvre ce chaînon, en aval de la billetterie, le jour J. Il ne prend aucun paiement.
...
Flavien Mauny
Studio Dragamig, https://www.dragamig.fr
https://www.linkedin.com/in/flavienmauny/

---

Note pratique : l'adresse de contact de l'équipe HelloAsso n'est pas connue. Passer par le formulaire de contact du site helloasso.com, ou demander à être mis en relation avec l'équipe produit. Ne pas inventer d'adresse électronique.
